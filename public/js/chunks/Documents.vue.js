(self["webpackChunk"] = self["webpackChunk"] || []).push([["Documents.vue"],{
...
/***/ "./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/components/Documents.vue?vue&type=script&lang=js":
/*!***************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/components/Documents.vue?vue&type=script&lang=js ***!
  \***************************************************************************************************************************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  methods: {
    mViewFile: function mViewFile(item) {
      var _this = this;
      return _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee() {
        var extension, fullUrl, response, blob, reader, _t;
        return _regenerator().w(function (_context) {
          while (1) switch (_context.p = _context.n) {
            case 0:
              _this.selectedFileName = item.Filename;
              extension = item.original_name.split(".").pop().toLowerCase();
              _this.fileType = extension;
              _this.excelData = [];
              _this.excelHeaders = [];
              _this.textContent = "";
              fullUrl = "".concat(_this.$url, "/storage/").concat(item.file_path);
              if (!(extension === "pdf")) {
                _context.n = 1;
                break;
              }
              _this.previewUrl = fullUrl;
              _this.previewDialog = true;
              _context.n = 10;
              break;
            case 1:
              if (!(extension === "txt" || extension === "xlsx" || extension === "xls" || extension === "csv")) {
                _context.n = 9;
                break;
              }
              _context.p = 2;
              _context.n = 3;
              return axios__WEBPACK_IMPORTED_MODULE_1___default().get(fullUrl, {
                responseType: "blob"
              });
            case 3:
              response = _context.v;
            ...
            case 5:
              ...
              reader.onload = function (e) {
                ...
                var workbook = xlsx__WEBPACK_IMPORTED_MODULE_2__.read(data, {
                  type: "array"
                });
                var firstSheetName = workbook.SheetNames[0];
                var worksheet = workbook.Sheets[firstSheetName];
                var json = xlsx__WEBPACK_IMPORTED_MODULE_2__.utils.sheet_to_json(worksheet);
                if (json.length > 0) {
                  _this.excelHeaders = Object.keys(json[0]).map(function (key) {
                    return {
                      text: key,
                      value: key
                    };
                  });
                  _this.excelData = json;
                  _this.fileType = "xlsx";
                }
                _this.previewDialog = true;
              };
            ...
            case 7:
              _context.p = 7;
              _t = _context.v;
              console.error("Axios Error:", _t);
              _this.$toast.error("File access denied (CORS Error).");
            case 8:
              _context.n = 10;
              break;
            case 9:
    ...
    mUpDown: function mUpDown() {
      var _this2 = this;
      this.isLoading = true;
      var employeecode = this.$store.state.credentials[0].EmployeeCode;
      var TeamID = this.$store.state.credentials[0].TeamID;
      var ChapterID = this.$store.state.ChapterID;
      var SystemID = this.$store.state.SystemID;
      axios__WEBPACK_IMPORTED_MODULE_1___default().get("".concat(this.$url, "/api/UpDown"), {
        params: {
          ChapterID: ChapterID,
        ...
        _this2.UpDownTableData = res.data;
      })["catch"](function (_ref) {
    ...
    mAddUpDown: function mAddUpDown() {
      ...
      this.uploading = true;
      this.uploadProgress = 0;
      axios__WEBPACK_IMPORTED_MODULE_1___default().post("".concat(this.$url, "/api/UpDown"), formData, {
        onUploadProgress: function onUploadProgress(progressEvent) {
          var percentCompleted = Math.round(progressEvent.loaded * 100 / progressEvent.total);
          _this3.uploadProgress = percentCompleted;
        }
      }).then(function () {
        _this3.uploading = false;
        _this3.uploadProgress = 100;
        _this3.$toast.success("File has been added successfully!");
        _this3.mCloseAdd();
        _this3.mUpDown();
        ...
        //   this.$toast.error(`Error ${response.status}: Failed to upload the file.`);
        // }
      })["finally"](function () {
        // A slight timeout makes the animation feel smoother
        // if the API is too fast
        setTimeout(function () {
    ...
    mDelete: function mDelete(item) {
      ...
      this.$swal({
        title: "Are you sure?",
        text: "You are about to delete the file: ".concat(item.Filename, "."),
        width: 600,
        // padding: "3em",
        ...
        background: "#fff url('/TS/images/dandelion.jpg')",
        imageAlt: "Custom image"
      }).then(function (result) {
        if (result.isConfirmed) {
          _this4.isLoading = true;
          axios__WEBPACK_IMPORTED_MODULE_1___default()["delete"]("".concat(_this4.$url, "/api/UpDown/delete"), {
            data: {
              file_path: item.file_path
            }
          }).then(function () {
            _this4.$toast.success("The file \"".concat(item.Filename, "\" has been deleted!"));
            _this4.mUpDown();
          })["catch"](function (_ref3) {
            var response = _ref3.response;
            if (response.status == 400) {
              _this4.$toast.error(response.data);
            } else {
              _this4.$store.dispatch("setStatusCode", response.status);
              _this4.$router.push("/error/" + response.status);
              _this4.$toast.error("Error ".concat(response.status, ": Failed to delete the file."));
            }
          })["finally"](function () {
    ...
    mDownload: function mDownload(item) {
      var _this5 = this;
      this.filenames = item.Filename;
      this.downloading = true;
      this.downloadProgress = 0;
      axios__WEBPACK_IMPORTED_MODULE_1___default().get("".concat(this.$url, "/api/UpDown/create?path=").concat(item.file_path), {
        responseType: "blob",
        onDownloadProgress: function onDownloadProgress(progressEvent) {
          var percentCompleted = Math.round(progressEvent.loaded * 100 / progressEvent.total);
          _this5.downloadProgress = percentCompleted;
        }
      }).then(function (res) {
        _this5.downloadProgress = 100;
        ...
        _this5.$toast.success("Download for \"".concat(item.Filename, "\" Completed."));
      })["catch"](function (_ref4) {
        var response = _ref4.response;
        if (response && response.status == 400) {
          _this5.$toast.error(response.data || "Error initiating download.");
        } else if (response) {
          _this5.$store.dispatch("setStatusCode", response.status);
          _this5.$router.push("/error/" + response.status);
          _this5.$toast.error("Error ".concat(response.status, ": Failed to download the file."));
        } else {
          _this5.$toast.error("Network or server error during download.");
        }
      })["finally"](function () {
        _this5.downloading = false;
        _this5.filenames = "";
        _this5.downloadProgress = 0;
      });
    }
  },
  computed: {
    cSearchPL: function cSearchPL() {
      if (!this.searchTable) {
        return this.UpDownTableData;
      }
      var search = this.searchTable.toLowerCase();
      return this.UpDownTableData.filter(function (rec) {
        var itemIdMatch = rec.ItemID && rec.ItemID.toString().includes(search);
        var filenameMatch = rec.Filename && rec.Filename.toLowerCase().includes(search);
        return itemIdMatch || filenameMatch;
      });
    }
  }
});
...
/***/ "./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/lib/loaders/templateLoader.js??ruleSet[1].rules[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/components/Documents.vue?vue&type=template&id=e5703e46&scoped=true":
/*!**************************************************************************************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/lib/loaders/templateLoader.js??ruleSet[1].rules[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/components/Documents.vue?vue&type=template&id=e5703e46&scoped=true ***!
  \**************************************************************************************************************************************************************************************************************************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
var render = function render() {
  var _vm = this,
    _c = _vm._self._c;
  return _c("v-card", {
    staticClass: "ma-3 book-page-container",
    attrs: {
      elevation: "12"
    }
  }, [_c("v-overlay", {
    ...
    staticClass: "book-loading-container"
  }, [_c("div", {
    staticClass: "book-vault"
  }, [_c("div", {
    staticClass: "page-base left-page"
  }), _vm._v(" "), _c("div", {
    staticClass: "page-base right-page"
  }), _vm._v(" "), _c("div", {
    staticClass: "flipping-page"
  }), _vm._v(" "), _c("div", {
    staticClass: "flipping-page"
  }), _vm._v(" "), _c("div", {
    staticClass: "flipping-page"
  })]), _vm._v(" "), _c("div", {
    staticClass: "loading-text text-uppercase mt-10"
  }, [_vm._v("\n        LOADING " + _vm._s(this.$store.state.System) + "...\n      ")])])]), _vm._v(" "), _c("v-card-title", {
    staticClass: "book-header py-6 px-8"
  }, [_c("v-row", {
    attrs: {
      align: "center",
      "no-gutters": ""
    ...
    staticClass: "chapter-display"
  }, [_c("h2", {
    staticClass: "chapter-title rubik-vinyl-regular"
  }, [_vm._v("\n            " + _vm._s(this.$store.state.System) + "\n          ")])])]), _vm._v(" "), _c("v-col", {
    attrs: {
      cols: "12",
      sm: "5"
    }
  }, [_c("v-text-field", {
    staticClass: "paper-search",
    attrs: {
  ...
  }, [_vm.$store.state.credentials[0].EmployeeCode == "45035" ? _c("v-btn", {
    staticClass: "upload-bookmark",
    attrs: {
      dark: ""
    },
    on: {
  ...
  }, [_vm._v("mdi-upload")]), _vm._v("\n          Upload File\n        ")], 1) : _vm._e()], 1)], 1)], 1), _vm._v(" "), _c("v-divider", {
    staticClass: "mx-8 paper-divider"
    ...
    attrs: {
      "fixed-header": "",
      height: _vm.$vuetify.breakpoint.height - 280 + "px"
    },
    scopedSlots: _vm._u([{
      key: "default",
      fn: function fn() {
        ...
        }, [_vm._v("Download")]), _vm._v(" "), _c("th", {
          staticClass: "text-center",
          attrs: {
            width: "2"
          }
        }, [_vm._v("Delete")])])]), _vm._v(" "), _c("tbody", [_vm._l(_vm.cSearchPL, function (item, index) {
          return _c("tr", {
            key: index
          }, [_c("td", {
            staticClass: "text-center font-weight-bold grey--text"
          }, [_vm._v(_vm._s(index + 1))]), _vm._v(" "), _c("td", {
            staticClass: "text-left file-name-cell"
          }, [_vm._v(_vm._s(item.Filename))]), _vm._v(" "), _c("td", {
            staticClass: "text-center"
          }, [_c("v-btn", {
            attrs: {
              icon: "",
            ...
            on: {
              click: function click($event) {
                return _vm.mViewFile(item);
              }
            }
          }, [_c("v-icon", [_vm._v("mdi-eye-outline")])], 1)], 1), _vm._v(" "), _c("td", {
            staticClass: "text-center"
          }, [_c("v-tooltip", {
            attrs: {
              bottom: ""
            ...
            scopedSlots: _vm._u([{
              ...
              fn: function fn(_ref) {
                ...
                }, "div", attrs, false), on), [_vm.downloading && _vm.filenames === item.original_name ? _c("v-progress-circular", {
                  attrs: {
                    indeterminate: "",
                    size: "24",
                    width: "3",
                ...
                }, [_c("v-icon", [_vm._v("mdi-cloud-download-outline")])], 1)], 1)];
              }
            }], null, true)
          }, [_vm._v(" "), _c("span", [_vm._v("Download")])])], 1), _vm._v(" "), _c("td", {
            staticClass: "text-center"
          }, [_c("v-btn", {
            attrs: {
              icon: "",
            ...
            on: {
              click: function click($event) {
                return _vm.mDelete(item);
              }
            }
          }, [_c("v-icon", [_vm._v("mdi-trash-can-outline")])], 1)], 1)]);
        }), _vm._v(" "), _vm.cSearchPL.length === 0 ? _c("tr", [_c("td", {
          staticClass: "text-center py-10 grey--text italic-text",
          attrs: {
            colspan: "5"
          }
        }, [_vm._v("\n              No documents found in this archive.\n            ")])]) : _vm._e()], 2)];
      },
      proxy: true
    }])
  ...
  }), _vm._v(" "), _vm.uploading ? _c("v-progress-linear", {
    staticClass: "mb-4 rounded-sm",
    attrs: {
  ...
  }, [_c("v-icon", [_vm._v("mdi-close")])], 1), _vm._v(" "), _c("v-toolbar-title", [_vm._v("Preview: " + _vm._s(_vm.selectedFileName))])], 1), _vm._v(" "), _c("v-card-text", {
    staticClass: "pa-0",
    staticStyle: {
      "overflow-y": "auto"
    },
    attrs: {
      height: _vm.$vuetify.breakpoint.height - 60 + "px"
    }
  }, [_vm.fileType === "pdf" ? _c("iframe", {
    staticClass: "pb-n5",
    attrs: {
      src: _vm.previewUrl,
      width: "100%",
      height: _vm.$vuetify.breakpoint.height - 54 + "px",
      frameborder: "0"
    }
  }) : _vm.fileType === "txt" ? _c("v-sheet", {
    staticClass: "pa-5",
    attrs: {
      color: "grey lighten-4",
      height: _vm.$vuetify.breakpoint.height - 55 + "px"
    }
  }, [_c("pre", {
    staticStyle: {
      "white-space": "pre-wrap"
    }
  }, [_vm._v(_vm._s(_vm.textContent))])]) : _vm.fileType === "xlsx" ? _c("v-data-table", {
    staticClass: "elevation-10",
    attrs: {
      headers: _vm.excelHeaders,
      items: _vm.excelData,
      dense: "",
      "fixed-header": "",
      height: _vm.$vuetify.breakpoint.height - 123 + "px",
      "items-per-page": 25
    }
  }) : _c("v-container", {
  ...
  }, [_vm._v("mdi-file-question")]), _vm._v(" "), _c("p", [_vm._v("Preview not available for this file type. Please download to view.")])], 1)], 1)], 1)], 1), _vm._v(" "), _c("ChatComponent", {
    attrs: {
  ...
  }, [_c("v-icon", [_vm._v("mdi-chat-processing")])], 1)], 1);
};
var staticRenderFns = [];
render._withStripped = true;
...
/***/ "./node_modules/laravel-mix/node_modules/css-loader/dist/cjs.js??clonedRuleSet-9.use[1]!./node_modules/vue-loader/lib/loaders/stylePostLoader.js!./node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-9.use[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/components/Documents.vue?vue&type=style&index=0&id=e5703e46&scoped=true&lang=css":
/*!************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/laravel-mix/node_modules/css-loader/dist/cjs.js??clonedRuleSet-9.use[1]!./node_modules/vue-loader/lib/loaders/stylePostLoader.js!./node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-9.use[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/components/Documents.vue?vue&type=style&index=0&id=e5703e46&scoped=true&lang=css ***!
  \************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************/
/***/ ((module, __webpack_exports__, __webpack_require__) => {
...
var ___CSS_LOADER_EXPORT___ = _node_modules_laravel_mix_node_modules_css_loader_dist_runtime_api_js__WEBPACK_IMPORTED_MODULE_0___default()(function(i){return i[1]});
___CSS_LOADER_EXPORT___.push([module.id, "@import url(https://fonts.googleapis.com/css2?family=Playfair+Display:ital,wght@0,700;1,400&display=swap);"]);
// Module
___CSS_LOADER_EXPORT___.push([module.id, "\n.book-loading-container[data-v-e5703e46] {\r\n  --book-width: 150px;\r\n  --book-height: 100px;\r\n  --page-color: #fdf5e6;\r\n  --border-color: #d2b48c;\r\n\r\n  display: flex;\r\n  flex-direction: column;\r\n  align-items: center;\r\n  justify-content: center;\n}\n.book-vault[data-v-e5703e46] {\r\n  width: var(--book-width);\r\n  height: var(--book-height);\r\n  position: relative;\r\n  perspective: 1200px;\r\n  transform-style: preserve-3d;\n}\n.page-base[data-v-e5703e46] {\r\n  position: absolute;\r\n  width: 50%;\r\n  height: 100%;\r\n  background-color: var(--page-color);\r\n  border: 1px solid var(--border-color);\r\n  box-shadow: 0 5px 15px rgba(0, 0, 0, 0.1);\n}\n.left-page[data-v-e5703e46] {\r\n  left: 0;\r\n  border-radius: 5px 0 0 5px;\r\n  background-image: linear-gradient(to right, rgba(0, 0, 0, 0.05) 0%, transparent 10%);\n}\n.right-page[data-v-e5703e46] {\r\n  right: 0;\r\n  border-radius: 0 5px 5px 0;\r\n  background-image: linear-gradient(to left, rgba(0, 0, 0, 0.05) 0%, transparent 10%);\n}\n.flipping-page[data-v-e5703e46] {\r\n  position: absolute;\r\n  right: 0;\r\n  width: 50%;\r\n  height: 100%;\r\n  background-color: var(--page-color);\r\n  border: 1px solid var(--border-color);\r\n  border-radius: 0 5px 5px 0;\r\n  transform-origin: left center;\r\n  animation: parchment-flip-e5703e46 2s infinite cubic-bezier(0.45, 0.05, 0.55, 0.95);\r\n  z-index: 5;\n}\n.flipping-page[data-v-e5703e46]:nth-child(3) {\r\n  animation-delay: 0.1s;\n}\n.flipping-page[data-v-e5703e46]:nth-child(4) {\r\n  animation-delay: 0.3s;\n}\n.flipping-page[data-v-e5703e46]:nth-child(5) {\r\n  animation-delay: 0.5s;\n}\n@keyframes parchment-flip-e5703e46 {\n0% {\r\n    transform: rotateY(0deg);\r\n    background-color: var(--page-color);\n}\n50% {\r\n    transform: rotateY(-90deg);\r\n    background-color: #eee0c5;\r\n    box-shadow: 20px 0 50px rgba(0, 0, 0, 0.2);\n}\n100% {\r\n    transform: rotateY(-180deg);\r\n    background-color: var(--page-color);\n}\n}\n.loading-text[data-v-e5703e46] {\r\n  color: #3c0753;\r\n  font-family: \"Playfair Display\", serif;\r\n  font-size: 1rem;\r\n  font-weight: 800;\r\n  letter-spacing: 3px;\r\n  text-shadow: 1px 1px 2px rgba(0, 0, 0, 0.1);\n}\r\n\r\n/* Main \"Paper\" Card */\n.book-page-container[data-v-e5703e46] {\r\n  background-color: #f4f1ea !important;\r\n  background-image: url(\"https://www.transparenttextures.com/patterns/paper-fibers.png\");\r\n  border: 1px solid #dcd9d0;\r\n  border-radius: 4px !important;\r\n  background-size: cover;\n}\n.playfair[data-v-e5703e46] {\r\n  font-family: \"Playfair Display\", serif;\n}\r\n\r\n/* Header Section */\n.book-header[data-v-e5703e46] {\r\n  background: transparent !important;\n}\n.chapter-label[data-v-e5703e46] {\r\n  display: block;\r\n  font-size: 0.7rem;\r\n  text-transform: uppercase;\r\n  letter-spacing: 2px;\r\n  color: #7f8c8d;\n}\n.chapter-title[data-v-e5703e46] {\r\n  color: #2c3e50;\r\n  margin-top: -5px;\n}\r\n\r\n/* Search bar looking like it's part of the paper */\n.paper-search[data-v-e5703e46] {\r\n  background: rgba(0, 0, 0, 0.05) !important;\r\n  border-radius: 20px !important;\n}\r\n\r\n/* Button styled like a Bookmark */\n.upload-bookmark[data-v-e5703e46] {\r\n  background-color: #e74c3c !important; /* Red like your system.vue close btn */\r\n  border-radius: 0 0 5px 5px !important;\r\n  top: -24px;\r\n  height: 50px !important;\r\n  box-shadow: 0 4px 6px rgba(0, 0, 0, 0.2) !important;\n}\r\n\r\n/* Table styling to look like a ledger */\n.paper-table[data-v-e5703e46] {\r\n  background: transparent !important;\n}\n.paper-table[data-v-e5703e46] thead th {\r\n  background-color: #e8e4d9 !important;\r\n  color: #2c3e50 !important;\r\n  font-family: \"Playfair Display\", serif;\r\n  font-weight: 700;\r\n  border-bottom: 2px solid #2c3e50 !important;\n}\n.paper-table[data-v-e5703e46] tbody tr {\r\n  transition: background 0.2s;\n}\n.paper-table[data-v-e5703e46] tbody tr:hover {\r\n  background: rgba(0, 0, 0, 0.02) !important;\n}\n.paper-table[data-v-e5703e46] td {\r\n  border-bottom: 1px dotted #bdc3c7 !important;\r\n  padding: 12px 8px !important;\n}\n.file-name-cell[data-v-e5703e46] {\r\n  color: #34495e;\r\n  font-size: 0.95rem;\n}\n.paper-divider[data-v-e5703e46] {\r\n  border-color: rgba(44, 62, 80, 0.1) !important;\n}\n.italic-text[data-v-e5703e46] {\r\n  font-style: italic;\n}\n.rubik-vinyl-regular[data-v-e5703e46] {\r\n  font-family: \"Rubik Vinyl\", system-ui;\r\n  font-size: 1.8rem;\n}\r\n", ""]);
// Exports
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (___CSS_LOADER_EXPORT___);
...
/* harmony import */ var _node_modules_style_loader_dist_runtime_injectStylesIntoStyleTag_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! !../../../node_modules/style-loader/dist/runtime/injectStylesIntoStyleTag.js */ "./node_modules/style-loader/dist/runtime/injectStylesIntoStyleTag.js");
/* harmony import */ var _node_modules_style_loader_dist_runtime_injectStylesIntoStyleTag_js__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_node_modules_style_loader_dist_runtime_injectStylesIntoStyleTag_js__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var _node_modules_laravel_mix_node_modules_css_loader_dist_cjs_js_clonedRuleSet_9_use_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_dist_cjs_js_clonedRuleSet_9_use_2_node_modules_vue_loader_lib_index_js_vue_loader_options_Documents_vue_vue_type_style_index_0_id_e5703e46_scoped_true_lang_css__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! !!../../../node_modules/laravel-mix/node_modules/css-loader/dist/cjs.js??clonedRuleSet-9.use[1]!../../../node_modules/vue-loader/lib/loaders/stylePostLoader.js!../../../node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-9.use[2]!../../../node_modules/vue-loader/lib/index.js??vue-loader-options!./Documents.vue?vue&type=style&index=0&id=e5703e46&scoped=true&lang=css */ "./node_modules/laravel-mix/node_modules/css-loader/dist/cjs.js??clonedRuleSet-9.use[1]!./node_modules/vue-loader/lib/loaders/stylePostLoader.js!./node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-9.use[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/components/Documents.vue?vue&type=style&index=0&id=e5703e46&scoped=true&lang=css");
...
var update = _node_modules_style_loader_dist_runtime_injectStylesIntoStyleTag_js__WEBPACK_IMPORTED_MODULE_0___default()(_node_modules_laravel_mix_node_modules_css_loader_dist_cjs_js_clonedRuleSet_9_use_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_dist_cjs_js_clonedRuleSet_9_use_2_node_modules_vue_loader_lib_index_js_vue_loader_options_Documents_vue_vue_type_style_index_0_id_e5703e46_scoped_true_lang_css__WEBPACK_IMPORTED_MODULE_1__["default"], options);
...
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony import */ var _Documents_vue_vue_type_template_id_e5703e46_scoped_true__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./Documents.vue?vue&type=template&id=e5703e46&scoped=true */ "./resources/js/components/Documents.vue?vue&type=template&id=e5703e46&scoped=true");
/* harmony import */ var _Documents_vue_vue_type_script_lang_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./Documents.vue?vue&type=script&lang=js */ "./resources/js/components/Documents.vue?vue&type=script&lang=js");
/* harmony import */ var _Documents_vue_vue_type_style_index_0_id_e5703e46_scoped_true_lang_css__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./Documents.vue?vue&type=style&index=0&id=e5703e46&scoped=true&lang=css */ "./resources/js/components/Documents.vue?vue&type=style&index=0&id=e5703e46&scoped=true&lang=css");
/* harmony import */ var _node_modules_vue_loader_lib_runtime_componentNormalizer_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! !../../../node_modules/vue-loader/lib/runtime/componentNormalizer.js */ "./node_modules/vue-loader/lib/runtime/componentNormalizer.js");
...
var component = (0,_node_modules_vue_loader_lib_runtime_componentNormalizer_js__WEBPACK_IMPORTED_MODULE_3__["default"])(
  ...
  _Documents_vue_vue_type_template_id_e5703e46_scoped_true__WEBPACK_IMPORTED_MODULE_0__.render,
  _Documents_vue_vue_type_template_id_e5703e46_scoped_true__WEBPACK_IMPORTED_MODULE_0__.staticRenderFns,
  false,
  null,
  "e5703e46",
  null
...
/***/ "./resources/js/components/Documents.vue?vue&type=style&index=0&id=e5703e46&scoped=true&lang=css":
/*!*******************************************************************************************************!*\
  !*** ./resources/js/components/Documents.vue?vue&type=style&index=0&id=e5703e46&scoped=true&lang=css ***!
  \*******************************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _node_modules_style_loader_dist_cjs_js_node_modules_laravel_mix_node_modules_css_loader_dist_cjs_js_clonedRuleSet_9_use_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_dist_cjs_js_clonedRuleSet_9_use_2_node_modules_vue_loader_lib_index_js_vue_loader_options_Documents_vue_vue_type_style_index_0_id_e5703e46_scoped_true_lang_css__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! -!../../../node_modules/style-loader/dist/cjs.js!../../../node_modules/laravel-mix/node_modules/css-loader/dist/cjs.js??clonedRuleSet-9.use[1]!../../../node_modules/vue-loader/lib/loaders/stylePostLoader.js!../../../node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-9.use[2]!../../../node_modules/vue-loader/lib/index.js??vue-loader-options!./Documents.vue?vue&type=style&index=0&id=e5703e46&scoped=true&lang=css */ "./node_modules/style-loader/dist/cjs.js!./node_modules/laravel-mix/node_modules/css-loader/dist/cjs.js??clonedRuleSet-9.use[1]!./node_modules/vue-loader/lib/loaders/stylePostLoader.js!./node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-9.use[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/components/Documents.vue?vue&type=style&index=0&id=e5703e46&scoped=true&lang=css");


/***/ }),

/***/ "./resources/js/components/Documents.vue?vue&type=template&id=e5703e46&scoped=true":
/*!*****************************************************************************************!*\
  !*** ./resources/js/components/Documents.vue?vue&type=template&id=e5703e46&scoped=true ***!
  \*****************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   render: () => (/* reexport safe */ _node_modules_babel_loader_lib_index_js_clonedRuleSet_5_use_0_node_modules_vue_loader_lib_loaders_templateLoader_js_ruleSet_1_rules_2_node_modules_vue_loader_lib_index_js_vue_loader_options_Documents_vue_vue_type_template_id_e5703e46_scoped_true__WEBPACK_IMPORTED_MODULE_0__.render),
/* harmony export */   staticRenderFns: () => (/* reexport safe */ _node_modules_babel_loader_lib_index_js_clonedRuleSet_5_use_0_node_modules_vue_loader_lib_loaders_templateLoader_js_ruleSet_1_rules_2_node_modules_vue_loader_lib_index_js_vue_loader_options_Documents_vue_vue_type_template_id_e5703e46_scoped_true__WEBPACK_IMPORTED_MODULE_0__.staticRenderFns)
/* harmony export */ });
/* harmony import */ var _node_modules_babel_loader_lib_index_js_clonedRuleSet_5_use_0_node_modules_vue_loader_lib_loaders_templateLoader_js_ruleSet_1_rules_2_node_modules_vue_loader_lib_index_js_vue_loader_options_Documents_vue_vue_type_template_id_e5703e46_scoped_true__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! -!../../../node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!../../../node_modules/vue-loader/lib/loaders/templateLoader.js??ruleSet[1].rules[2]!../../../node_modules/vue-loader/lib/index.js??vue-loader-options!./Documents.vue?vue&type=template&id=e5703e46&scoped=true */ "./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/lib/loaders/templateLoader.js??ruleSet[1].rules[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/components/Documents.vue?vue&type=template&id=e5703e46&scoped=true");
