(self["webpackChunk"] = self["webpackChunk"] || []).push([["documents"],{
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  methods: {
    ...
    mUpDown: function mUpDown() {
      var _this2 = this;
      this.isLoading = true;
      var employeecode = this.$store.state.credentials[0].EmployeeID;
    ...
    mAddUpDown: function mAddUpDown() {
      ...
      var employeecode = this.$store.state.credentials[0].EmployeeID;
      console.log(employeecode, 'kupal');
      var TeamID = this.$store.state.credentials[0].TeamID;
      var ChapterID = this.$store.state.ChapterID;
      var SystemID = this.$store.state.SystemID;
    ...
    mDelete: function mDelete(item) {
      ...
      this.$swal({
        ...
        background: "#fff url('/TS/storage/images/dandelion.jpg')",
...
var render = function render() {
  ...
  return _c("v-card", {
  ...
  }, [_c("v-icon", [_vm._v("mdi-arrow-left")])], 1), _vm._v(" "), _c("div", {
    staticClass: "chapter-display"
  }, [_c("h6", {
    staticClass: "italic-text"
  }, [_vm._v(_vm._s(this.$store.state.SystemName))]), _vm._v(" "), _c("h5", {
    ...
    scopedSlots: _vm._u([{
      ...
      fn: function fn() {
        ...
        }, [_vm._v("Delete")])])]), _vm._v(" "), _c("tbody", [_vm._l(_vm.cFindDocu, function (item, index) {
          return _c("tr", {
            key: index
          }, [_c("td", {
        ...
        }), _vm._v(" "), _vm.cFindDocu.length === 0 ? _c("tr", [_c("td", {
